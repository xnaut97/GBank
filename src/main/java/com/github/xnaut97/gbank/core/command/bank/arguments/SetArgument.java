...
public class SetArgument extends AbstractArgument implements AutoCompletion {

    public SetArgument(GBankPlugin plugin) {
        super(plugin);
    }
    ...
    public String getDescription() {
        return "set currency amount to specific player.";
    }

    @Override
    public String getUsage() {
        return "bank set [player] [currency] [amount]";
    }
    ...
    public void playerExecute(CommandSender sender, String[] args) {
        ...
        BankHelper.set(balance, amount);
        MessageUtils.sendMessage(player, "set-success",
                "@amount@:" + amount,
