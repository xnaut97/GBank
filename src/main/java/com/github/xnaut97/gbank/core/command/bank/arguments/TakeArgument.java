...
public class TakeArgument extends AbstractArgument implements AutoCompletion {

    public TakeArgument(GBankPlugin plugin) {
        super(plugin);
    }
    ...
    public String getDescription() {
        return "take currency amount to specific player.";
    }

    @Override
    public String getUsage() {
        return "bank take [player] [currency] [amount]";
    }
    ...
    public void playerExecute(CommandSender sender, String[] args) {
        ...
        BankHelper.take(balance, amount);
        MessageUtils.sendMessage(player, "take-success",
                "@amount@:" + amount,
